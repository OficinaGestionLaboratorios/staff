...
const WRITE_ACTIONS = ['create', 'update', 'delete', 'createHorario', 'updateHorario', 'deleteHorario',
  'createSobretiempo', 'updateSobretiempo', 'registrarDescansoSobretiempo', 'deleteSobretiempo','eliminarDescansoSobretiempo','crearSolicitudDescansoBanco','anularSolicitudDescansoBanco','registrarDescansoEfectuadoBanco','createPermiso', 'updatePermiso', 'deletePermiso',
...
function handleRequest(e) {
  ...
  switch (action) {
    ...
    case 'anularSolicitudDescansoBanco':
      return anularSolicitudDescansoBanco(params);
    case 'registrarDescansoEfectuadoBanco':
      return registrarDescansoEfectuadoBanco(params);
     case 'createPermiso':
