...
window.HorarioExport = (function() {
    const CSV_HEADERS = ['ID_GRUPO', 'EMPLEADO', 'ID_PERSONAL', 'CODE', 'ESTADO', 'FECHA_INICIO', 'FECHA_FIN', 'DIA', 'INGRESO', 'INICIO_REFRIGERIO', 'FIN_REFRIGERIO', 'SALIDA', 'HORAS_DIA', 'OBSERVACION', 'HORAS_SEMANA'];
        ...
        grupos.forEach(g => {
            (g.DIAS || []).forEach(d => {
                filas.push([
                    ...
                    d.finRef, d.salida, d.horas, d.obs, g.HORAS_SEMANA
                ]);
            });
        });
        return filas;
