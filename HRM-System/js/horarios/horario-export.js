...
window.HorarioExport = (function() {
    ...
    const CSV_HEADERS = ['ID_GRUPO', 'FECHA_REGISTRO', 'FECHA_ACTUALIZACION', 'CODE', 'ID_PERSONAL', 'EMPLEADO', 'FECHA_INICIO', 'FECHA_FIN', 'DIA', 'HORA_INGRESO', 'INICIO_REFRIGERIO', 'FIN_REFRIGERIO', 'HORA_SALIDA', 'HORAS_DIA', 'OBSERVACION', 'HORAS_SEMANA'];
