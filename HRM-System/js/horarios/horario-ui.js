            ...
            return `
                <div class="horario-grupo-item ${activo ? 'activo' : ''}" data-id-grupo="${window.esc(g.ID_GRUPO)}">
                    ...
                    <div class="horario-grupo-acciones">
                        ...
                        <button type="button" class="btn-chip btn-download-uniform" data-accion="descargar-grupo" data-id-grupo="${window.esc(g.ID_GRUPO)}" title="Descargar este horario (CSV)"><i class="fas fa-download"></i></button>
