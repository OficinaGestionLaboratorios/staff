            ...
            return `
                <div class="horario-grupo-item ${activo ? 'activo' : ''}" data-id-grupo="${window.esc(g.ID_GRUPO)}">
                    ...
                    <div class="horario-grupo-acciones">
                        ...
                        <button type="button" class="btn-chip btn-download-uniform" data-accion="descargar-grupo" data-id-grupo="${window.esc(g.ID_GRUPO)}" title="Descargar este horario (Excel)"><i class="fas fa-download"></i></button>
                        ...
                        <button type="button" class="btn-chip" data-accion="correo-grupo" data-id-grupo="${window.esc(g.ID_GRUPO)}" title="Ver y copiar carta de correo para este horario"><i class="fas fa-envelope"></i></button>
