...
window.API = {
    ...
    // No existe (a propósito) un método para borrar registros del todo.
    // El personal que deja de trabajar se marca como ESTADO=Inactivo
    // (ver toggleEstadoPersonal en js/personal/modal.js), nunca se borra.
};
