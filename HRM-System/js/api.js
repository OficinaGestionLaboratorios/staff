...
// ============================================================
// FUNCIÓN AUXILIAR: DESCARGAR JSON
// ============================================================
        ...
        try {
            ...
            if (fallback) {
                try {
                    ...
                    console.error('Error al parsear caché:', e2);
                }
            }
            window.toast('❌ Error: ' + e.message + '. Verifica que data/personal.json exista.', 'error');
            return [];
        }
    },
    ...
    async save(data, isEdit = false, code = '') {
        try {
            ...
            if (isEdit && code) {
                ...
                // Generar nuevo CODE si no tiene
                if (!data.CODE) {
