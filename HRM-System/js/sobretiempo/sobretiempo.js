...
window.abrirModalSobretiempo = async function() {
    ...
    if (dependenciaInput && !dependenciaInput.value) {
        ...
        dependenciaInput.value = p.PROGRAMA || p.LUGAR_TRABAJO || p.CARGO || '';
    }
...
// ============================================================
// Solo aquí se termina de completar la información de la solicitud;
// recién con esto ESTADO pasa a "Completo" y aparece el botón
// "Exportar" en la lista (ver sobretiempo-ui.js / renderLista).
