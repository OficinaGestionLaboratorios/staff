...
window.SobretiempoModel = (function() {
    ...
    // Se usa para las horas de CADA fecha (Fase 1), para las "horas
    // efectivas de descanso" (Fase 2) — mismo cálculo, distinto par
    // de horas.
    ...
    // (cada una con su campo "horas", string tipo "2.00").
    ...
    // "fechas" es el arreglo crudo que lee la UI (fecha, horaInicio,
    // horaFin, refrigerioInicio, refrigerioFin por cada fila de la
    // tabla); aquí se le calcula "horas" a cada una y se arma
    // FECHAS_JSON + el TOTAL_HORAS (suma de todas).
    ...
    // Sigue siendo UNA sola fecha/jornada de descanso, independiente
    // de cuántas fechas de ejecución tenga la Fase 1.
