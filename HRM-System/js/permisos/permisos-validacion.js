...
window.PermisosValidacion = (function() {
    ...
    function validar({ personal, funcionarioExpide, fechaPermiso, horaSalida, horaRetorno, motivoSalida, clasePermiso, otraEspecificar, lugarDestino }) {
        const errores = [];
        ...
        if (!horaSalida) errores.push('hora de salida');
        if (!horaRetorno) errores.push('hora de retorno');
