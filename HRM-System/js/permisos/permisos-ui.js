            ...
            return `
                <div class="horario-grupo-item ${activo ? 'activo' : ''}" data-id-permiso="${window.esc(r.ID_PERMISO)}">
                    ...
                    <div class="horario-grupo-acciones">
                        ...
                        <button type="button" class="btn-chip btn-download-uniform" data-accion="exportar-permiso" data-id="${window.esc(r.ID_PERMISO)}" title="Descargar boleta (2 copias)"><i class="fas fa-download"></i> Exportar</button>
