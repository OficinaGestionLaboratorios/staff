...
window.PermisosModel = (function() {
    ...
    // Arma el payload de creación/edición. OTRA_ESPECIFICAR y
    // LUGAR_DESTINO solo se envían cuando la clase marcada
    // efectivamente los necesita (igual que la boleta en papel:
    // esos campos solo aplican a "Otra" y "Comisión de Servicio").
    function construirPayload({ personal, funcionarioExpide, cargoFuncionario, dependencia, fechaPermiso, horaSalida, horaRetorno, motivoSalida, clasePermiso, otraEspecificar, lugarDestino, idPermiso }) {
        const payload = {
            CODE: personal.CODE,
