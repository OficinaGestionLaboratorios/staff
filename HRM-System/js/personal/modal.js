...
window.verDetalle = function(data) {
    ...
    if (idPersonal) {
        ...
        avatarContainer.innerHTML = `<img src="${fotoURL}" alt="${window.esc(fullName)}" onerror="this.style.display='none';this.parentElement.innerHTML='<i class=\\'fas fa-user-circle no-photo\\' style=\\'font-size:44px;color:#94A3B8;\\'></i>';this.parentElement.style.background='#f1f5f9';">`;
    } else {
        avatarContainer.innerHTML = `<i class="fas fa-user-circle no-photo" style="font-size:44px;color:#94A3B8;"></i>`;
    }
