...
const WRITE_ACTIONS = ['create', 'update', 'delete', 'createHorario', 'updateHorario', 'deleteHorario',
  'createSobretiempo', 'updateSobretiempo', 'registrarDescansoSobretiempo', 'deleteSobretiempo','eliminarDescansoSobretiempo','crearSolicitudDescansoBanco','createPermiso', 'updatePermiso', 'deletePermiso',
